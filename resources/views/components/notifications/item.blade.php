...
<div class="rounded-2xl border border-slate-200 p-4 transition bg-slate-100/90 hover:bg-slate-200">
    <div class="flex gap-3">
        <div class="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-full {{'bg-indigo-100 text-indigo-700' }}">
